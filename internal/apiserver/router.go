...
import (
	...
	"github.com/ThinkHao/nfa/internal/apiserver/controller/v1/ipgroup"
...
func installController(g *gin.Engine) *gin.Engine {
	...
	v1 := g.Group("/v1")
	{
		...
		// ipgroup RESTful resourse
		ipgroupv1 := v1.Group("/ipgroups", middleware.Publish())
		{
			ipgroupController := ipgroup.NewIPGroupController(storeIns)

			ipgroupv1.GET("", ipgroupController.List)
			ipgroupv1.GET(":ipgroup_name", ipgroupController.Get)
		}
	}
